-- Een oefening archiveren in plaats van verwijderen.
--
-- Swipen in de bibliotheek verwijderde de `exercises`-rij. De sets koppelen op naam, dus
-- die bleven staan — maar `muscle` was weg, en al dat volume viel vanaf dat moment onder
-- "Overig" in Volume per spiergroep. Archiveren haalt de oefening uit de kiezers en de
-- bibliotheek en laat de rij (en dus de spiergroep van je historie) staan.
--
...
-- sync_push_v2 opnieuw, met de kolom erin. Verder identiek aan 0020.
