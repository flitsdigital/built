-- Weekplanning per gebruiker (profiles.schedule) + sets/reps-doelen per routine-oefening (routines.targets).
...
-- sync_push opnieuw definiëren zodat de nieuwe velden meegaan.
...
begin
  ...
  insert into public.routines (user_id, name, exercises, alternatives, targets, created_at)
