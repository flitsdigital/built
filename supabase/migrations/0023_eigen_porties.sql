-- Eigen porties per product.
--
-- De portie-chips waren een gok op de categorie: 50/100/250 g voor alles wat geen brood,
-- ei, zuivel of drank is. Een Italiaanse bol van 260 g stond er dus met drie knoppen die
-- geen van drieën klopten, en dan typ je het getal elke keer opnieuw.
--
-- `portions` is een jsonb-array van {label, amount} — dezelfde vorm als `journal` op
-- day_habits. Los van `serving_grams`, want dat is wat OpenFoodFacts of de verpakking
-- zegt; dit is wat jij er werkelijk van neemt.
--
...
-- sync_push_v2 opnieuw, met de kolom erin. Verder identiek aan 0022.
