-- Eten optioneel maken (tracks_food) + dag-check-in: energie, stemming, spierpijn, stress.
-- Alle check-in-waarden: 0 = niet ingevuld, 1-5 = laag..hoog.
...
-- sync_push bijgewerkt: neemt tracks_food en de check-in-velden mee.
