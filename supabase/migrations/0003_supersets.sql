...
begin
  ...
  insert into public.routines (user_id, name, exercises, alternatives, targets, supersets, created_at)
    select uid, e->>'name', coalesce(e->'exercises', '[]'::jsonb),
           coalesce(e->'alternatives', '{}'::jsonb), coalesce(e->'targets', '{}'::jsonb),
           coalesce(e->'supersets', '{}'::jsonb), (e->>'created_at')::timestamptz
