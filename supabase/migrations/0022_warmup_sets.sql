-- Warming-up-sets worden opgeslagen.
--
-- Ze bestonden alleen in de lopende training: je stelde je eigen ramp samen, rondde af,
-- en de volgende keer was 'ie weg (#105). Nu gaan ze als gewone rij mee, met een vlag —
-- en telt alles wat een getal maakt (volume, records, e1RM, de body-map) op `.work`,
-- de sets zonder die vlag.
--
...
-- sync_push_v2 opnieuw, met de kolom erin. Verder identiek aan 0021.
